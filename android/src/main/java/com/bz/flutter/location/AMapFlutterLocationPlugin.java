package com.bz.flutter.location;
...
public class AMapFlutterLocationPlugin implements FlutterPlugin, MethodCallHandler,
  ...
  private static final String CHANNEL_METHOD_LOCATION = "bz_location";
  private static final String CHANNEL_STREAM_LOCATION = "bz_location_stream";
