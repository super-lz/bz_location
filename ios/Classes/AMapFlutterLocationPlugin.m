...
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
    FlutterMethodChannel* channel = [FlutterMethodChannel
                                     methodChannelWithName:@"bz_location"
    ...
    FlutterEventChannel *eventChanel = [FlutterEventChannel eventChannelWithName:@"bz_location_stream" binaryMessenger:[registrar messenger]];
